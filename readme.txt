Lagrange interpolating polynomial for free energy estimates
release 2, September 8, 2009
...
Synopsis:
=========
This archive contains the implementation of Lagrange interpolating polynomial
for estimates of free energy differences using thermodynamic integration. It
also contains an example data file to jumpstart use of the software. The
...
The purpose of this program is to construct a Lagrange interpolating polynomial
...
The Lagrange interpolation program takes three command-line parameters:
...
dozen. High degree of Lagrange polynomials suffers greatly from numerical
...
numerical differences are only notable after the eighth digit. The Newton
